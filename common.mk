...
PRODUCT_COPY_FILES += \
    ...
    device/sony/common/rootfs/system/etc/audio_policy.conf:system/vendor/etc/audio_policy.conf \
    device/sony/common/rootfs/system/etc/gps.conf:system/etc/gps.conf \
    device/sony/common/rootfs/system/etc/media_codecs.xml:system/etc/media_codecs.xml \
